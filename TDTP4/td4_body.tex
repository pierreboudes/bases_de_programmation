  ...
  \begin{table}[h]
      %\begin{center}
        \setlength{\unitlength}{\tabcolsep}
         ...
         31 &  & 2 & \\ \hline
         35  &  & 3 & \\ \hline
         33  &\multicolumn{3}{|l|}{renvoie false}\\ \hline
        \end{tabular}
              }
          }\\ \hline
          19 & & L'entier 9 n'est pas xxx\\ \hline
          23 &\multicolumn{2}{|l|}{renvoie EXIT\_SUCCESS}\\ \hline
          \end{tabular}
          %\end{center}
...
void afficher_rectangle(int largeur, int hauteur)
{
    ...
    for (i = 0; i < hauteur; i += 1) { /* pour chaque ligne */
