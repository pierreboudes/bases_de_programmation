...
\entete{Travaux dirigés 1 : programmation en mini-assembleur.}
...
\section{Trace de programme assembleur}
...
Quelles sont les valeurs contenues dans les registres 0, 1 et 2 après arrêt sur l'instruction \C{stop} ?
