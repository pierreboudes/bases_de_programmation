...
let nb_ques = 57  (* nombre de questions par QCM *)

let input = "question2.tex" (* fichier d'entrée *)
...
\\begin{document}
\\noindent
{Nom : \\hspace{4cm} Prénom : \\hspace{4cm} N$^{\\circ}$ étudiant : }

\\noindent
\\rule{\\linewidth}{0.5mm}\\\\
\\noindent
%Licence 1 - 1er semestre, Universit\\'e Paris-Nord, Institut Galil\\'ee \\hfill Ann\\'ee 2011--2012\\\\
%\\vspace{-.2cm}
\\begin{center}
Licence 1 - 1er semestre {{\\Large\\bf Éléments d'informatique -- contrôle continue}} 2011--2012\\\\
\\end{center}
\\rule{\\linewidth}{0.5mm}
\\begin{center}
Barème~: $1$ points par réponse juste (unique à chaque question) ; $-0,5$ points par réponse fausse. Durée : $20$ minutes.%Note maximale : $20$.
\\end{center}
%\\vspace{1cm}
...
\\vfill
\\begin{center}
\\emph{\\large N'oubliez pas de mettre vos prénom, nom, numéro d'étudiant au recto.}
\\end{center}
\\vfill
\\end{document}
