...
let nb_qcm = 240  (* Nombre de QCM à générer *)
let nb_ques = 20  (* nombre de questions par QCM *)

let input = "question.tex" (* fichier d'entrée *)
...
let is_valid qcm =  (List.length (List.filter dif1 qcm))= 5
...
\\noindent
Licence 1 - 1er semestre, Universit\\'e Paris-Nord, Institut Galil\\'ee \\hfill Ann\\'ee 2010--2011\\\\
\\vspace{-.2cm}
\\begin{center}
{{\\Large\\bf Éléments d'informatique -- contrôle continue}}
\\end{center}
\\rule{\\linewidth}{0.5mm}
\\begin{center}
