...
\begin{itemize}
  ...
  \item \structure{Types de données :} entiers,  \structure{caractères,
    réels,} tableaux, \structure{struct}
  \item Fonctions d'entrées/sorties (scanf/printf)
\item \structure{Écriture et appel de fonctions}
  \item \structure{Débogage}
\end{itemize}
...
\begin{itemize}
\item mêmes types d'exercices avec différents types de données (\C{int},
  \C{char}, \C{double}, \C{struct})  et des fonctions
